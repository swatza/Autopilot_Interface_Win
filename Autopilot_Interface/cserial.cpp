...
{
	std::cout << "Attempting to open port: " << nPort << " at " << nBaud << " baud" << std::endl;
	...
	cbDest = 50 * sizeof(char);
	pszFormat = TEXT("%s%d:%d%s");
	StringCbPrintf(szComParams, cbDest, pszFormat, "COM", nPort, nBaud, ",n,8,1");
